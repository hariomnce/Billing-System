...
CREATE TABLE product_item (
  ...
  date_modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE INDEX product_item_code_UNIQUE (product_item_code ASC),
...
CREATE TABLE biller (
  ...
  date_modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE INDEX bill_no_UNIQUE (bill_no ASC),
...
CREATE TABLE purchase_order (
  ...
  date_modified datetime DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE INDEX purchase_order_code_UNIQUE (purchase_order_code ASC),
