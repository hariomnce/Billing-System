...
public class OfferService extends BaseService {
	...
	public ResponseMessage save(OfferInfo offerInfo) {
		...
		ResponseMessage responseMessage = ResponseMessage.withResponseData(newOfferInfo, "Offer saved successfully",
				Constants.INFO_TYPE);
	...
	public ResponseMessage findResourceById(String id) throws Exception {
		...
		ResponseMessage responseMessage = ResponseMessage.withResponseData(offerInfo, Constants.SUCCESS_STATUS,
				Constants.INFO_TYPE);
		return responseMessage;
	}
	...
	public ResponseMessage findAll() throws Exception {
		...
		ResponseMessage responseMessage = ResponseMessage.withResponseData(offerInfos, Constants.SUCCESS_STATUS,
				Constants.INFO_TYPE);
		return responseMessage;
	}
}
