...
public class KitchenService extends BaseService {
    ...
    public ResponseMessage<KitchenOrderInfo> save(KitchenOrderInfo kitchenOrderInfo) {
        ...
        KitchenOrderInfo newKitchenOrderInfo = KitchenOrderMapper.INSTANCE.kitchenOrderToKitchenOrderInfo(newKitchenOrder);
        ResponseMessage<KitchenOrderInfo> responseMessage = ResponseMessage.withResponseData(newKitchenOrderInfo, "Kitchen Order Created %s",kitchenOrder.getKitchenOrderCode());
