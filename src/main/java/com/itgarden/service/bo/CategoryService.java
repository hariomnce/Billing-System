...
public class CategoryService extends BaseService {
	...
	public ResponseMessage save(CategoryInfo categoryInfo) {
		...
		ResponseMessage responseMessage = ResponseMessage.withResponseData(categoryInfoResponse,
				"Category Saved" + " Successfully", Constants.INFO_TYPE);
	...
	public ResponseMessage findAll() throws Exception {
		...
		ResponseMessage responseMessage = ResponseMessage.withResponseData(categoryInfos, Constants.SUCCESS_STATUS,
				Constants.INFO_TYPE);
		return responseMessage;
	}
}
